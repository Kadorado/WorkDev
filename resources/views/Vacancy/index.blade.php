    ...
    @if ($vacantes !== 'mensaje de error')
        ...
        <div class=" content-center	 p-4 border-b">
            <div class="text-center">
                <a href="vacante/create" class="justify-center w-32 p-3 mx-6 text-white bg-green-600 rounded-lg shadow outline-none focus:bg-green-700 hover:bg-green-500">Crear Vacante</a>
            </div>
