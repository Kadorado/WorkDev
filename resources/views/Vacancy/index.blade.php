                                    ...
                                    <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4">
                                        ...
                                        <div class="space-y-2">
                                            <div class="border-2 flex items-center p-2 rounded justify-between space-x-2">
                                                <form action="{{ route('vacante.destroy',$vacante->id) }}" method="POST">
                                                    <a href="/vacante/{{$vacante->id}}/edit" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark"><i class="fas fa-pencil-alt"></i></a>
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-red hover:bg-red-dark"><i class="fas fa-trash"></i>
                                                        </i></button>
                                                </form>
                                            </div>
                                        </div>
...
<div class="text-center">
    <h1 class="text-center text-gray-600 mb-8">LLena tus datos antes de crear una vacante</h1>
    <p class="text-center text-gray-600 mb-8">
		Completa  los datos para que puedas crear convocatorias y recibir los mejores perfiles
		en el slider del lado izquierdo podras encontrar el formulario para realizar este importante paso en el icono de edificio 
