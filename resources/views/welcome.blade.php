        ...
        <div class="pt-0">
            <div class="container flex flex-col flex-wrap items-center px-3 mx-auto mb-8 md:flex-row">
                ...
                <div
                    ...
                    <p class="mb-8 text-2xl leading-normal font-bold">
            ...
            <div class="container flex flex-wrap pt-4 pb-12 mx-auto">
                ...
                <div class="flex flex-col flex-grow flex-shrink w-full p-6 md:w-1/3">
                    <div class="flex-1 overflow-hidden bg-white rounded-t rounded-b-none shadow">
                            ...
                            <br />
                            <p class="px-6 mx-auto my-5 text-center text-gray-800">
                                Despues de aplicar en multiples plataformas de empleo workdev me brindo una forma facil y
                ...
                <div class="flex flex-col flex-grow flex-shrink w-full p-6 md:w-1/3">
                    <div class="flex-1 overflow-hidden bg-white rounded-t rounded-b-none shadow">
                            ...
                            <br />
                            <p class="px-6 mx-auto my-5 text-center text-gray-800">
                                Haber encontrado a workDev fue lo mejor que me pudo haber pasado , despues de intentar en otras plataformas sin encontrar resultados efectivos.
                            </p>
        ...
        <section>
            <div class="container max-w-5xl m-8 mx-auto">
                ...
                <div class="flex flex-wrap text-center">
                    <div class="w-full p-6 sm:w-1/2">
                        <!--ventajas para empresas-->
                        <h3 class="mb-3 text-2xl font-bold leading-none text-white-800">
                            Otras plataformas
                        </h3>
                        <!--una imagen de beneficios-->
                        <img class="shadow-lg rounded-3xl" src="https://peaku.co/img/business/candidatos_otros.svg" alt="">
                        <p class="mb-8 text-white-600 font-bold">
                            <br />
                            <br />
                            Procesos de reclutamiento lentos , confusos y que no terminan bien.
                            <br />
                            <br />
                        </p>
                    </div>
                    <div class="w-full p-6 sm:w-1/2">
                        <!--ventajas para empresas-->
                        <h3 class="mb-3 text-2xl font-bold leading-none text-white-800">
                            Como operamos en WorkDev
                        </h3>
                        <!--una imagen de beneficios-->
                        <img class="shadow-lg rounded-3xl" src="https://peaku.co/img/business/candidatos_peaku_blue.svg"
                            alt="">
                        <p class="mb-8 text-white-600 font-bold">
                            <br />
                            <br />
                            Proceso de reclutamiento rapidos , solo toma 3 pasos.
                            <br />
                            <br />
                        </p>
                    </div>
        ...
        <section class="w-full max-w-2xl px-6 py-4 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            ...
            <div class="mt-6 ">
                ...
                <div class="flex justify-center mt-6">
                    <button
                        class="px-4 py-2 text-white transition-colors duration-200 transform bg-blue-300 rounded-md hover:bg-yellow-500 focus:outline-none focus:bg-gray-600">enviar</button>
                </div>
            </div>
        </section>
