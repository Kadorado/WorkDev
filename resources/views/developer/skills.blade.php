    ...
    @if ($userSkills === 'mensaje de error')
        <div class="flex flex-col items-center justify-center w-full text-center md:w-4/5 md:text-center">
            ...
            <a href="/developerdata">
                <button
                    class="px-8 py-2 mb-8 font-bold text-center text-blue-600 transition duration-300 ease-in-out transform bg-blue-200 rounded-full shadow-lg lg:mx-0 focus:outline-none focus:shadow-outline hover:bg-blue-500 hover:text-white hover:scale-105">Completar
                    perfil</button> </a>
        </div>
