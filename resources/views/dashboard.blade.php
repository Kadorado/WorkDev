...
<h1>¡Hola Quedo admin!</h1>
@endif

                <p class="leading-normal text-2xl mb-8">
                    Bienvenido a la mejor plataforma para ofertar y aplicar a propuestas laborales del mundo del desarrollo
                </p>
            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-center text-gray-600 mb-8">
                        Segun tu rol llena los datos para que puedas crear convocatorias o aplicar a ellas
